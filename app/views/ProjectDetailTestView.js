...
class ProjectDetailTestView extends Component {
                                    ...
                                    <div className="panel-heading">
                                        <div className="panel-options">
                                            <ul className="nav nav-tabs">
                                                ...
                                                <li className=""><a href="#tab-2" data-toggle="tab" onClick={() => this.loadPhaseData()}>Phase Details</a></li>
                                                <li className=""><a href="#tab-3" data-toggle="tab" onClick={() => this.loadEstFactorData()}>Estimating Factors</a></li>
                                                <li className=""><a href="#tab-4" data-toggle="tab" onClick={() => this.loadInventoryData()}>Inventory</a></li>
                                            </ul>
                                        </div>
                                    </div>
...
export default ProjectDetailTestView;